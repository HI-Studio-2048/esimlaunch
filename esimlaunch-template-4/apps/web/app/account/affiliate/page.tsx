  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:py-16">
      <div className="mb-8 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-void">Affiliate Dashboard</h1>
        <Link
          href="/account"
      ...
      <div className="card mb-8 p-6">
        <h2 className="mb-2 font-semibold text-void">Your referral code</h2>
        <p className="mb-4 font-mono text-2xl font-bold text-void">{affiliate.referralCode}</p>
        <p className="mb-2 text-sm text-dim">Shareable link:</p>
      ...
      {/* Commissions summary */}
      <div className="card mb-8 p-6">
        <h2 className="mb-4 font-semibold text-void">Commissions summary</h2>
        <p className="text-2xl font-bold text-void">{totalFormatted}</p>
        <p className="mt-1 text-sm text-dim">Total earned (includes pending)</p>
        {affiliate.isFrozen && (
      ...
      {/* Recent referrals */}
      <div className="card mb-8 p-6">
        <h2 className="mb-4 font-semibold text-void">Recent referrals</h2>
        {recentReferrals.length === 0 ? (
          <p className="text-sm text-dim">No referrals yet. Share your link to get started!</p>
        ) : (
      ...
      <div className="card p-6">
        <h2 className="mb-4 font-semibold text-void">Recent commissions</h2>
        {recentCommissions.length === 0 ? (
          <p className="text-sm text-dim">No commissions yet.</p>
        ) : (
          <ul className="space-y-2">
