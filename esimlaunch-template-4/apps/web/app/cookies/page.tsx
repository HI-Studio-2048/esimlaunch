...
export default function CookiesPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      <h1 className="text-3xl font-bold text-void">Cookie Policy</h1>
      <p className="mt-4 text-sm text-faint">Last updated: {lastUpdated}</p>

      <section className="mt-12 space-y-6 text-dim">
        <h2 className="text-xl font-semibold text-void">1. What Are Cookies?</h2>
        <p>
          Cookies are small text files stored on your device when you visit a website. They
          help websites remember your preferences and improve your experience.
        </p>

        <h2 className="text-xl font-semibold text-void">2. Cookies We Use</h2>
        ...
        <h2 className="text-xl font-semibold text-void">3. Third-Party Cookies</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">4. Managing Cookies</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">5. Contact</h2>
        <p>
