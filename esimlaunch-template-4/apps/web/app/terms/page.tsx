  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <section className="mt-12 space-y-6 text-dim">
        ...
        <h2 className="text-xl font-semibold text-void">3. Account and Payments</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">4. Use of Service</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">5. Refunds</h2>
        <p>
          Refund policy is set out in our{' '}
          <a href="/refund" className="text-link hover:underline">
            Refund Policy
          </a>
          .
        </p>

        <h2 className="text-xl font-semibold text-void">6. Limitations</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">7. Changes</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">8. Contact</h2>
        <p>
