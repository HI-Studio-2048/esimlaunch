...
export default function RefundPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      <h1 className="text-3xl font-bold text-void">Refund Policy</h1>
      <p className="mt-4 text-sm text-faint">Last updated: {lastUpdated}</p>

      <section className="mt-12 space-y-6 text-dim">
        <h2 className="text-xl font-semibold text-void">1. Before Activation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">2. After Activation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">3. Technical Issues</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">4. Device Incompatibility</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">5. Processing Time</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">6. Contact</h2>
        <p>
          ...
          or open a{' '}
          <Link href="/support" className="text-link hover:underline">
            support ticket
          </Link>
          .
        </p>
