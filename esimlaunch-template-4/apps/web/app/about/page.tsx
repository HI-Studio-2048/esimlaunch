...
export default function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      <h1 className="text-3xl font-bold text-void">About Us</h1>
      <p className="mt-4 text-dim">{tagline}</p>

      <section className="mt-12 space-y-6 text-dim">
        <h2 className="text-xl font-semibold text-void">Our Story</h2>
        <p>{mission}</p>

        <h2 className="text-xl font-semibold text-void">How It Works</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-void">What We Offer</h2>
