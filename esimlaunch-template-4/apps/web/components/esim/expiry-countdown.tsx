...
export function ExpiryCountdown({
  ...
  if (!expiry) {
    return (
      <span className={cn('text-[#6e6e73]', className)}>Expiry unknown</span>
    );
  }

  if (!time) {
    return (
      <span className={cn('text-[#6e6e73]', className)}>Invalid date</span>
    );
  }
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent className="border border-[#d2d2d7] bg-white text-[#1d1d1f] shadow-card">
