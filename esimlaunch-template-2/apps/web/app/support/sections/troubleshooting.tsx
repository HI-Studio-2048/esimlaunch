    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <Card className="border-surface-border bg-white">
          <CardHeader>
            <CardTitle className="text-lg text-ink">QR code won&apos;t scan</CardTitle>
          </CardHeader>
        ...
        <Card className="border-surface-border bg-white">
          <CardHeader>
            <CardTitle className="text-lg text-ink">No network after activation</CardTitle>
          </CardHeader>
          <CardContent className="text-ink-secondary">
            <p>
        ...
        <Card className="border-surface-border bg-white">
          <CardHeader>
            <CardTitle className="text-lg text-ink">Need more help?</CardTitle>
          </CardHeader>
          <CardContent className="text-ink-secondary">
            <p>
              <Link href="/support/tickets/new" className="font-medium text-teal-400 hover:underline">
                Create a support ticket
              </Link>{' '}
              or{' '}
              <Link href="/contact" className="font-medium text-teal-400 hover:underline">
                contact us
              </Link>
              .
            </p>
