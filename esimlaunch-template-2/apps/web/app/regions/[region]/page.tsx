...
export default function RegionPage({
  ...
  if (!VALID_REGIONS.includes(regionSlug)) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-16 text-center">
        <h1 className="text-2xl font-bold text-ink">Region not found</h1>
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 lg:px-8">
      <Link href="/">
        <Button variant="ghost" className="mb-6 pl-0 text-ink-secondary hover:bg-transparent hover:text-ink">
          <ArrowLeft className="mr-2 h-4 w-4" /> Back to Home
        </Button>
      </Link>

      <div className="relative overflow-hidden rounded-card-lg border border-surface-border bg-gradient-to-r from-teal-400/10 to-teal-400/5 p-8 md:p-12">
      ...
      {regionSlug === 'global' ? (
        <div className="mt-8 space-y-4">
          <h2 className="text-2xl font-bold text-ink">Global eSIM Plans</h2>
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            >
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-btn border border-surface-border bg-surface-soft">
                  <span className="text-xs font-bold text-ink-muted">GL</span>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-ink">Global (120+ areas)</h3>
                  <p className="text-sm text-ink-secondary">120+ countries coverage</p>
                </div>
              </div>
              <ArrowRight className="h-5 w-5 text-ink-faint transition-colors group-hover:text-teal-400" />
            </Link>
            <Link
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-ink">Global (130+ areas)</h3>
                  <p className="text-sm text-ink-secondary">130+ countries coverage</p>
                </div>
              </div>
              <ArrowRight className="h-5 w-5 text-ink-faint transition-colors group-hover:text-teal-400" />
            </Link>
        ...
        <div className="mt-8 space-y-4">
          ...
          {loading ? (
            ...
            <div className="rounded-card-lg border-2 border-dashed border-surface-border bg-surface-soft py-20 text-center text-ink-secondary">
