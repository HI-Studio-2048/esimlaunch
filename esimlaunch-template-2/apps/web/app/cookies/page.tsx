  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <section className="mt-12 space-y-6 text-ink-secondary">
        <h2 className="text-xl font-semibold text-ink">1. What Are Cookies?</h2>
        <p>
          Cookies are small text files stored on your device when you visit a website. They
          help websites remember your preferences and improve your experience.
        </p>

        <h2 className="text-xl font-semibold text-ink">2. Cookies We Use</h2>
        ...
        <h2 className="text-xl font-semibold text-ink">3. Third-Party Cookies</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">4. Managing Cookies</h2>
        <p>
