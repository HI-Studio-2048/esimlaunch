  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <section className="mt-12 space-y-6 text-ink-secondary">
        <h2 className="text-xl font-semibold text-ink">1. Acceptance</h2>
        <p>
          By using this website and purchasing eSIM plans, you agree to these Terms of Service.
          If you do not agree, please do not use our services.
        </p>

        <h2 className="text-xl font-semibold text-ink">2. Service Description</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">3. Account and Payments</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">4. Use of Service</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">5. Refunds</h2>
        <p>
          Refund policy is set out in our{' '}
          <a href="/refund" className="text-teal-400 hover:underline">
            Refund Policy
          </a>
          .
        </p>

        <h2 className="text-xl font-semibold text-ink">6. Limitations</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">7. Changes</h2>
        <p>
