...
export default function RefundPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      <h1 className="text-3xl font-bold text-ink">Refund Policy</h1>
      <p className="mt-4 text-sm text-ink-muted">Last updated: {lastUpdated}</p>

      <section className="mt-12 space-y-6 text-ink-secondary">
        <h2 className="text-xl font-semibold text-ink">1. Before Activation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">2. After Activation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">4. Device Incompatibility</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-ink">5. Processing Time</h2>
        <p>
