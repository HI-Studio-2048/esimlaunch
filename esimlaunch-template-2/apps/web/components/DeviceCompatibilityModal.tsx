  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-card bg-white p-6 shadow-xl">
        <h2 className="text-xl font-bold text-ink">Is your device eSIM compatible?</h2>
        ...
        <label className="mt-6 flex cursor-pointer items-center gap-3">
          <input
            ...
            className="h-4 w-4 rounded border-surface-border text-teal-400 focus:ring-teal-400"
          />
          <span className="text-sm text-ink">I understand my device must support eSIM</span>
        </label>
        <div className="mt-8 flex gap-3">
          ...
          <button
            ...
            disabled={!understood}
            className="btn-primary flex-1 px-4 py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
          >
