  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <section className="mt-12 space-y-6" style={{ color: 'var(--text-muted)' }}>
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>1. Information We Collect</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>2. How We Use It</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>3. Data Sharing</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>4. Data Security</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>5. Cookies</h2>
        <p>
          We use cookies and similar technologies for essential functionality, authentication,
          and analytics. See our{' '}
          <Link href="/cookies" style={{ color: 'var(--electric)' }} className="hover:underline">
            Cookie Policy
          </Link>{' '}
          for details.
        </p>

        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>6. Your Rights</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>7. Contact</h2>
        <p>
