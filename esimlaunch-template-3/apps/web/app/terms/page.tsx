  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      ...
      <section className="mt-12 space-y-6" style={{ color: 'var(--text-muted)' }}>
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>1. Acceptance</h2>
        <p>
          By using this website and purchasing eSIM plans, you agree to these Terms of Service.
          If you do not agree, please do not use our services.
        </p>

        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>2. Service Description</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>3. Account and Payments</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>4. Use of Service</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>5. Refunds</h2>
        <p>
          Refund policy is set out in our{' '}
          <a href="/refund" style={{ color: 'var(--electric)' }} className="hover:underline">
            Refund Policy
          </a>
          .
        </p>

        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>6. Limitations</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>7. Changes</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold" style={{ color: 'var(--text)' }}>8. Contact</h2>
        <p>
          For questions about these terms, please{' '}
          <a href="/contact" style={{ color: 'var(--electric)' }} className="hover:underline">
            contact us
          </a>
          .
        </p>
