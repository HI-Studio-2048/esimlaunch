  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 sm:py-12">
      ...
      <nav className="mb-8 text-sm text-slate-500">
        ...
        <span className="mx-2">/</span>
        <Link href={`/countries/${slug}`} className="hover:text-slate-700">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        ...
        <dl className="space-y-4 border-y border-slate-200 py-6">
          <div className="flex justify-between">
            <dt className="text-slate-500">Data</dt>
            <dd className="font-medium text-slate-900">{formatVolume(plan.volume)}</dd>
          </div>
          <div className="flex justify-between">
          ...
          {plan.supportTopUpType === 2 && (
            <div className="flex justify-between">
              <dt className="text-slate-500">Top-up</dt>
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-3">
            <Link
              href={`/countries/${slug}`}
              className="rounded-xl border border-slate-200 px-6 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
            >
              Back to plans
            </Link>
            <button
              ...
              className="rounded-xl bg-gradient-to-r from-violet-500 to-purple-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/30 transition hover:from-violet-600 hover:to-purple-600 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {checkingOut ? (
