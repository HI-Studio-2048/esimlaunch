...
export default function EsimSetupGuidePage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:py-24">
      <h1 className="text-3xl font-bold text-slate-900">eSIM Setup Guide</h1>
      ...
      <div className="mt-12 space-y-10">
        {STEPS.map((step, i) => (
          <div key={i} className="flex gap-6">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-violet-100 text-violet-700 font-semibold">
              {i + 1}
            </div>
            <div>
      ...
      <div className="mt-16 rounded-xl border border-violet-100 bg-violet-50 p-6">
        <h2 className="text-lg font-semibold text-slate-900">Things to know about eSIM</h2>
      ...
      <div className="mt-12 flex flex-wrap gap-4">
        <Link
          href="/help-center"
          className="inline-flex items-center rounded-lg bg-violet-600 px-4 py-2 text-white hover:bg-violet-500"
        >
          Back to Help Center
        </Link>
        <Link
          href="/support"
          className="inline-flex items-center rounded-lg border border-slate-200 px-4 py-2 text-slate-700 hover:bg-slate-50"
        >
